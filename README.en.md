...
## Current Experience
**Touch Health (Touch Tecnologia) - Software Developer (Remote)**  
Nov/2023 - Present

- Maintain and evolve enterprise healthcare systems (VeDocs/inTouch ecosystem).
- Implement improvements and new features across backend and frontend.
- Build and support REST API, HL7, and DICOM/PACS integrations and interoperability scenarios.
- Fix bugs, refactor code, and improve system performance.
- Support authentication and security flows with OIDC/Keycloak.
...
- Practices: Scrum, SOLID, CI/CD, Automated testing (Spock, Vitest, Cypress)

## Education
- Bachelor's Degree in Information Technology (UNIVESP) - in progress
- Associate Degree in Systems Analysis and Development (UTFPR) - completed

## Contact
- LinkedIn: https://www.linkedin.com/in/gustavoluche/
- Email: gustavoluche8@gmail.com
